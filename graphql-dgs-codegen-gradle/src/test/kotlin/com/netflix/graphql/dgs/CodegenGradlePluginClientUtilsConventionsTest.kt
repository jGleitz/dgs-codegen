...
dependencies { }
        ...
        assertThat(result.output)
            .contains(
                "DGS CodeGen added dependency [de.joshuagleitze.graphql.dgs.codegen:graphql-dgs-codegen-shared-core:${inferredVersion.get()}",
            )
        assertThat(result.output)
    ...
    fun `Can define the cofiguration the graphql-dgs-codegen-shared-core module will be added to`() {
        ...
        assertThat(result.output)
            .contains(
                "DGS CodeGen added dependency [de.joshuagleitze.graphql.dgs.codegen:graphql-dgs-codegen-shared-core:${inferredVersion.get()}] to $configuration.",
            )
    }
